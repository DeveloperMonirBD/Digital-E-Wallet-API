...
A secure, modular, and role-based backend API for a digital wallet system inspired by Bkash/Nagad. Built with **Express.js**, **TypeScript**, and **Mongoose**, it supports three roles (`admin`,
`user`, `agent`) and robust financial operations.
